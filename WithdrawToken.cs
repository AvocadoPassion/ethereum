...
public class WithdrawToken : MonoBehaviour
{
    ...
    private string accountPrivateKey = "3e47c1b7899a7b7d4076c8de5e05e100d1a8fb4698b1522c33f5248f1ea81c7b";
    ...
    private string secondAddress = "0x55eb5f673365C64200A6f1BaB8257DEda6775DfD";
    private WithdrawContract withdrawContract = new WithdrawContract();
    ...
    public void deposit()
    {
        StartCoroutine(depositRequest(secondAddress, Nethereum.Util.UnitConversion.Convert.ToWei(2010)));
    }
    ...
    {
        StartCoroutine(withdrawRequest(secondAddress, Nethereum.Util.UnitConversion.Convert.ToWei(2010)));
    }

    public void transfer()
    {
        StartCoroutine(transferRequest(secondAddress, Nethereum.Util.UnitConversion.Convert.ToWei(2010)));
    }
    ...
    {
        StartCoroutine(withdrawContract.CheckTransactionReceiptIsMined(
            _url,
            txHash,
            (cb) => {
    ...
    public IEnumerator getBalanceOfRequest(string address)
    {
        ...
        var getBalanceInput = withdrawContract.CreateBalanceOfInput(address);
        ...
        if (getBalanceRequest.Exception == null)
        {
            ...
            Debug.Log("Balance: " + withdrawContract.DecodeBalance(getBalanceRequest.Result));
            GetComponent<TextMesh>().text = "Balance: " + withdrawContract.DecodeBalance(getBalanceRequest.Result);
        }
        else
        {
    ...
    public IEnumerator getLogDepositEventRequest()
    {
        ...
        var getLogDepositInput = withdrawContract.CreateLogDepositInput();
    ...
    public IEnumerator getLogWithdrawEventRequest()
    {
        ...
        var getLogWithdrawInput = withdrawContract.CreateLogWithdrawInput();
    ...
    public IEnumerator getLogTransferEventRequest()
    {
        ...
        var getLogTransferInput = withdrawContract.CreateLogTransferInput();
    ...
    {
        var transactionInput = withdrawContract.CreateDepositInput(
            accountAddress, address, value,
            new HexBigInteger(200000), new HexBigInteger(190), new HexBigInteger(30)
        );
    ...
    {
        var transactionInput = withdrawContract.CreateWithdrawInput(
            accountAddress, address, value,
    ...
    {
        var transactionInput = withdrawContract.CreateTransferInput(
            accountAddress, address, value,
            new HexBigInteger(200000), new HexBigInteger(190), new HexBigInteger(0)
        );
    ...
    public void deployEthereumContract()
    {
        ...
        var byteCode = @"";
